...
\SetWatermarkText{\color{red} \transparent{0.2}Draft. Please do not cite. V1.0}
...
\title{Online Appendix for: \mytitle}
\author{\myauthors}
...
This document provides the online appendix to ``\textit{\mytitle}''. 
...
\newpage
\section{Source code for Figure 1}

\lstinputlisting[basicstyle=\small,language=TeX]{figure.tex}
